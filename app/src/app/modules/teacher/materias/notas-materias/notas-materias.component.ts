...
@Component({
  selector: 'app-notas-materias',
  imports: [CommonModule, FormsModule],
  templateUrl: './notas-materias.component.html',
  styleUrl: './notas-materias.component.css'
})
export class NotasMateriasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.materiasService.getNotasByInstanciaId(this.instanciaId).subscribe((notas: NotasMaterias[]) => {
      this.notas = notas;
  ...
  calcularFinal(nota: NotasMaterias): void {
