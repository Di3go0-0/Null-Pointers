...
@Component({
  selector: 'app-horario-instancia',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './horario-instancia.component.html',
  styleUrl: './horario-instancia.component.css'
})
export class HorarioInstanciaComponent implements OnInit {
  ...
  addSubject() {
    this.router.navigate([`admin/asignatures/instancias/Horario/crear`, this.instanciaId]);
  }
